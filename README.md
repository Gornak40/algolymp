...
5. Set the `ejudge.ulocation` config parameter to [location](https://ejudge.ru/wiki/index.php/Userdb:users). Leave it empty if you use only one printer.
